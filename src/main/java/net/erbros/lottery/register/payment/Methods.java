...
import net.erbros.lottery.register.payment.methods.VaultEco;
...
/**
 * The
 * <code>Methods</code> initializes Methods that utilize the Method interface
 ...
 * </pre></blockquote>
 *
 * @author: Nijikokun <nijikokun@shortmail.com> (@nijikokun) @copyright:
 * Copyright (C) 2011 @license: AOL license <http://aol.nexua.org>
 */
public class Methods {
    ...
    /**
     * Interprets Plugin class data to verify whether it is compatible with an
     * existing payment method to use for payments and other various economic
     * activity.
     *
